...
namespace UnityEngine.EventSystems
{
    ...
    /// You can assign multiple functions to a single event
    /// and whenever the EventTrigger receives that event it will call those functions in the order they were provided.
    ///
    /// NOTE: Attaching this component to a GameObject will make that object intercept ALL events,
    /// and no events will propagate to parent objects.
    /// </remarks>
    /// <example>
    /// There are two ways to intercept events:
    /// (1) You could extend EventTrigger, and override the functions for the events you are interested in intercepting; as shown in this example:
    /// <code>
    /// using UnityEngine;
    ...
    /// }
    /// </code>
    /// (2) or you can specify individual delegates:
    /// <code>
    /// using UnityEngine;
    /// using UnityEngine.EventSystems;
    ///
