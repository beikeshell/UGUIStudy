namespace UnityEngine.EventSystems
{
    ...
    /// </summary>
    /// <remarks>
    /// MoveDirection provides a way of switching between moving states.
    /// You must assign these states to actions, such as moving the GameObject by an up vector when in the Up state.
    /// Having states like these are easier to identify than always having to include a large amount of vectors and calculations.
    /// Instead, you define what you want the state to do in only one part, and switch to the appropriate state when it is needed.
    /// </remarks>
    /// <example>
    /// <code>
